...
**Memex.** This engine (`memex`), and also the name of the conceptual lineage (Vannevar Bush's "memex" from _As We May Think_, 1945). MemexLab is the specific instance.
